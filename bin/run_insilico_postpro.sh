...
"./drug_sim" -input_deck ./input_deck.txt -hill_file ./chantest_hill/$drugname/IC50_samples.csv -init_file ./result/$formatted_concentration.csv -herg_file ./chantest_herg/$drugname/$drugname.csv
